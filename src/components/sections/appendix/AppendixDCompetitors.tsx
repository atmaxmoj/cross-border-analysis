...
export default function AppendixDCompetitors() {
  return (
    <Section id="appendix-d" title="D. Competitor Landscape">
      <h3>ESL-Specific Job Boards</h3>
      ...
      <h3 style={{ marginTop: '30px' }}>Asia Teaching Platforms</h3>
      <table style={{ fontSize: '0.9em', width: '100%' }}>
        <thead>
          <tr style={{ background: '#edf2f7' }}>
            <th style={{ textAlign: 'left', padding: '10px' }}>Competitor</th>
      ...
      <h3 style={{ marginTop: '30px' }}>General Job Platforms (China & Asia)</h3>
      <table style={{ fontSize: '0.9em', width: '100%' }}>
        <thead>
          <tr style={{ background: '#edf2f7' }}>
            <th style={{ textAlign: 'left', padding: '10px' }}>Competitor</th>
      ...
      <h3 style={{ marginTop: '30px' }}>Global Job Platforms</h3>
      <table style={{ fontSize: '0.9em', width: '100%' }}>
        <thead>
          <tr style={{ background: '#edf2f7' }}>
            <th style={{ textAlign: 'left', padding: '10px' }}>Competitor</th>
      ...
      <h3 style={{ marginTop: '30px' }}>Community & Social Platforms</h3>
      <table style={{ fontSize: '0.9em', width: '100%' }}>
        <thead>
          <tr style={{ background: '#edf2f7' }}>
            <th style={{ textAlign: 'left', padding: '10px' }}>Competitor</th>
      ...
      <h3 style={{ marginTop: '30px' }}>Support Services (Adjacent Competition)</h3>
      <table style={{ fontSize: '0.9em', width: '100%' }}>
        <thead>
          <tr style={{ background: '#edf2f7' }}>
            <th style={{ textAlign: 'left', padding: '10px' }}>Competitor</th>
